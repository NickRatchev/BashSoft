namespace BashSoft
{
    public static class ExceptionMessages
    {
        ...
        public const string UnauthorizedAccesExeptionMessage = "The folder/file you are trying to get access needs a higher level of rights than you currently have.";
